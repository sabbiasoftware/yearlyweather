...
function generateStats() {
    ...
    weatherStatistics.value.generateStatistics(locator.value.selectedLocation.lon, locator.value.selectedLocation.lat, dateSelector.value.selectedDates, dateSelector.value.dayDelta);
}
